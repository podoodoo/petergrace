  ...
  return (
    <>
      <section className="flex container m-auto h-screen justify-center items-center">
        <div className="flex flex-col md:flex-row pt-15 px-10 md:py-8 md:px-14 md:max-w-screen-md md:max-h-[600px] h-full w-full justify-center items-center bg-[url('./assets/card.png')] bg-[rgba(252,242,239,1)] drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
