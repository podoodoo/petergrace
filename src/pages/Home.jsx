...
function Home() {
  return (
    <div className="flex flex-col w-full h-full align-center">
      <h1 className="w-full text-center text-4xl mb-10 pt-16 md:pt-24 md:text-6xl">
        Peter & Grace
      </h1>
      <div className="flex justify-center align-middle overflow-hidden m-5 md:m-20">
        <img src={pic7} alt="7.jpg" className="md:w-3/4 md:object-none md:object-[-270px_-750px] md:blur-[1px]" />
      </div>
